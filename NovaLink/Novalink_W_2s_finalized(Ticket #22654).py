    ...
    with open(path_fstdout__,'a') as fstdout__, \
        ...
        with contextlib.redirect_stdout(fstdout__), \
            ...
            def send_email(plan_name, salutation, primary_contact_email, pbroker_email, census_contact_email, payroll_contact_email, novalink_contact_email, admin_phone_number, admin_email, am_sig):
                ...
                <p class=MsoNormal>You have engaged Novalink for census preparation. For Novalink to proceed with the census preparation, we need you to confirm that your payroll data to prepare the W-2s for the year is complete and final. <o:p></o:p></p>
                <p class=MsoNormal><b>ACTION REQUIRED:</b> Send me an email confirming your payroll data used to prepare the W-2s is finalized for the year.<o:p></o:p></p>
                <p class=MsoNormal>Upon receipt of your email, we will move forward with the process to load your census data to <a href="https://plansponsorlink.com/nova401k/login?returnUrl=%2Fnova401k%2F">PlanSponsorLink</a>. You will receive an additional notification once the census data has been loaded so you can review the data and approve the year-end data collection.<o:p></o:p></p>
                <p class=MsoNormal>Thank you for the opportunity to assist you with the administration of your plan. If you have any other questions, please contact me at {admin_phone_number} or {admin_email}.<o:p></o:p></p>
                <p class=MsoNormal>Sincerely,<o:p></o:p></p>
                <p class=MsoNormal>{am_sig}<o:p></o:p></p></div></body></html>
                """.replace('\n','<br>')
                
                toaddr = [primary_contact_email]
                cc_list = [pbroker_email, census_contact_email, payroll_contact_email, novalink_contact_email]
                ...
                if len(toaddrs) == 0:
                    ...
                    msg['To'] = ','.join(toaddr)
                    msg['CC'] = ','.join(cc_list)
                    subject = f'ACTION REQUIRED- 2023 W-2s – {plan_name}'
                    msg['Subject'] = subject
            ...
            def get_worktray():
                ...
                filt1 = df['task_name'] == 'Email Confirmation W-2s are Finalized'
            ...
            def get_active_records():
                ...
                for index, row in df.iterrows():
                    ...
                    #add note to Novalink Census Upload project within the plan
                    ...
                    # override the task Email Confirmation W-2s are Finalized
