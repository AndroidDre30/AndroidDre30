...
#headers = {'username': 'keshih', 'apikey': 'sRV0s9eOGOn598FdyYq81cf5'}
headers = {'username': 'kiandret', 'apikey': 'UeT70u9Kfo6814FFF8Cppw6A'}
...
@retry()
def add_project(planid, ProjectTemplateId, StartDate=None, DueOn=None, PeriodStart=None, PeriodEnd=None, filters=None, expand=None):
...
@retry()
def add_project_file(filepath, ProjectId, ProjectFileTypeId=586, ShowOnWeb=True, Title=None, Comment='', Archived=False, HasBeenWarned=True):
...
@retry()
def delete_project_file(projectFileId):
...
@retry()
def get_project_files_by_projectid(projid, filters=None, expand=None, skip=None, top=None, orderby=None):
...
@retry()
def get_tasks_by_taskgroupid(taskGroupId, taskOrderId=None, filters=None, expand=None, skip=None, top=None, orderby=None):
...
@retry()
def get_plan_by_planid(planid, select=None, expand=None):
...
@retry()
def get_plan_contact_roles_by_planid(planid, filters=None, expand='Contact,RoleType', skip=None, top=None):
...
@retry()
def get_contact_by_id(contactid, expand='ContactPhoneNumberLinks.PhoneNumber,ContactPhoneNumberLinks.PhoneNumberType'):
...
@retry()
def get_legal_plan_files_by_planid(planid, filters=None, expand=None, skip=None, top=None, orderby=None):
...
@retry()
def update_legal_plan_file(payload, expand=None):
...
@retry()
def add_legal_plan_file(filepath, planid, LegalPlanFileTypeId=1446, ShowOnWeb=True, Title=None, Comment='', Archived=False, HasBeenWarned=True):
...
@retry()
def delete_legal_plan_file(legalPlanFileId):
...
@retry()
def add_admin_form_plan_file(filepath, planid, AdminFormPlanFileTypeId=636, ShowOnWeb=True, Title=None, Comment='', Archived=False, HasBeenWarned=True):
...
@retry()
def get_employee_plan_roles_by_planid(planid, filters=None, expand='Contact,RoleType', skip=None, top=None, orderby=None):
...
@retry()
def put_employee_plan_role(payload, expand=None):
...
@retry()
def get_fee_schedules_by_planid(planid, filters=None, expand=None, skip=None, top=None, orderby=None):
...
@retry()
def add_distribution(planid, DistributionReasonId=None, Participant=None, ProjectTemplateId=None, InvestmentProviderLinkId=None, FeeScheduleItemTemplateId=None, FeeScheduleItemId=None, filters=None, expand=None):
...
def get_worktray2(name, get_all=False):
...
@retry()
def get_project_by_projectid(projid, expand=None):
...
@retry()
def update_plan(payload, select=None, expand=None):
...
@retry()
def update_project_file(payload, expand=None):
...
@retry()
def add_distribution_file(filepath, ProjectId, DistributionFileTypeId=1013, ShowOnWeb=True, Title=None, Comment='', Archived=False, HasBeenWarned=True):
...
@retry()
def get_project_fields(filters, expand=None, skip=None, top=None, orderby=None):
...
@retry()
def update_fee_schedule(payload, expand=None):
...
@retry()
def copy_fee_schedule_from_template(planid, StartDate, FeeScheduleTemplateId, FeeScheduleStatusId, Description=None, HasBeenWarned=False, IsDeactivated=False, filters=None, expand=None):
...
@retry()
def update_fee_schedule_item(payload, expand=None):
...
@retry()
def get_dashboard(name, get_all=False, addfilt=None, n=79):
    
    first_name, last_name = name.split(' ', maxsplit=1)
    
    contact = get_contacts(filters = f'FirstName eq "{first_name}" and LastName eq "{last_name}"')[0]
    contactid = contact['Id']
    filters = f"AssignedToId eq {contactid} and TaskActive ne null and DateCompleted eq null and TaskGroup.Project.CompletedOn eq null and (TaskGroup.Project.StartDate le '{today}' or TaskGroup.Project.StartDate eq null)"
...
@retry()
def get_plan_cycles_by_planid(planid, filters=None, expand=None, skip=None, top=None, orderby=None):
...
@retry()
def update_plan_cycle(payload, expand=None):
...
@retry()
def update_employee_plan_role(payload, expand=None):
...
@retry()
def delete_employee_plan_role(employeePlanRoleId):
...
@retry()
def delete_plan(planid, sysplanid=False):
...
def get_woktray(name, get_all=False):
...
@retry()
def get_distribution_by_id(projectId, expand=None):
...
@retry()
def update_distribution(payload, expand=None):
...
@retry()
def update_note(payload, expand=None):
...
@retry()
def add_investment_provider(payload, filters=None, expand=None):
...
@retry()
def update_investment_provider(payload, expand=None):
...
@retry()
def get_participants_by_projectid(projid, filters=None, expand=None):
...
@retry()
def add_plan_contact_right(planid, contactid, rightid, HasBeenWarned=False, IsDeactivated=False, filters=None, expand=None):
...
@retry()
def get_contact_notes_by_contactid(contactid, filters=None, expand=None):
...
@retry()
def get_project_notes_by_projectid(projid, filters=None, expand=None):
...
@retry()
def add_plan_contact_role(planid, ContactId, RoleTypeId, HasBeenWarned=False, IsDeactivated=False, ShouldCC=False, ShouldBCC=False, ShowOnWeb=True, filters=None, expand=None):
