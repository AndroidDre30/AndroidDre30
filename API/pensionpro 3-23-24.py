...
#headers = {'username': 'kelvinshihafs', 'apikey': '1FDL5D64j2sn1cWykcs93v68'}
...
@retry()
def add_project(planid:str, ProjectTemplateId:int, StartDate=None, DueOn=None, PeriodStart=None, PeriodEnd=None, filters=None, expand=None):
...
def get_worktray(name:str, get_all:bool=False, addfilt:str=None, n:int=75, dashboard:bool=False, simp:bool=False):
    ...
    cols = ['projid', 'planid', 'plan_name', 'proj_name', 'plan_status', 'plan_category', 'plan_type', 'form5500', 'plan_end', 'eff_on', 'pbgc', 'proj_due_on', 'per_start', 'per_end', 'plan_group', 'admin_type', 'priority', 'ipid', 'ip_eff_on', 'add_on']
    ...
    if simp:
        dfw = dfw[['planid', 'plan_name', 'projid', 'proj_name', 'taskid', 'task_name']].copy()
