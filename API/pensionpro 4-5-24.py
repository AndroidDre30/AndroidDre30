...
headers = {'username': 'kiandrethomas', 'apikey': 'UeT70u9Kfo6814FFF8Cppw6A'}
...
def get_worktray(name:str, get_all:bool=False, addfilt:str=None, n:int=75, dashboard:bool=False, simp:bool=False, dtf:bool=False):
